...
* Run the full pixelmon test suite <!-- , as described in the [developer documentation][dev-doc] -->, and ensure that all tests pass.
...
Samples: (even more [samples](https://github.com/1ziton/pixelmon/commits/master))
