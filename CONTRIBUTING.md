...
You can file new issues by filling out our [new issue form](https://github.com/1ziton/pokemon/issues/new).


### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

* Search [GitHub](https://github.com/1ziton/pokemon/pulls) for an open or closed PR
...
Samples: (even more [samples](https://github.com/1ziton/pokemon/commits/master))
