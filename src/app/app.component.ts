...
import { PIXELMON_I18N_TOKEN, TitleService, VERSION as VERSION_ALAIN } from '@pixelmon/theme';
...
export class AppComponent {
  ...
  constructor(
    ...
    renderer.setAttribute(el.nativeElement, 'yzt-version', VERSION_ALAIN.full);
    ...
    this.router.events.subscribe(evt => {
      ...
      const urlLang = url.split('/').pop() || this.i18n.zone;
      // 去掉全球化
