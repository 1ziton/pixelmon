export const ZHCN = {
  ...
  'app.home.feature.pixelmon': '一组更高阶的业务组件、图表、认证、授权、缓存、Mock、测试等',
  ...
  'app.home.feature.tool.desc': '包含 Pixelmon Schematics 、VSCODE插件',
  ...
  'app.header.menu.pixelmon': 'Pixelmon库',
  'app.header.menu.auth': '@pixelmon/auth-用户认证',
  'app.header.menu.acl': '@pixelmon/acl-访问控制列表',
  'app.header.menu.cache': '@pixelmon/cache-缓存',
  'app.header.menu.chart': '@pixelmon/chart-图表',
  'app.header.menu.mock': '@pixelmon/mock-Mock模拟数据',
  'app.header.menu.util': '@pixelmon/util-工具集',
