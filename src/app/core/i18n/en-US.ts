export const ENUS = {
  ...
  'app.home.feature.pokemon': 'A set of higher-order components, chart, authentication, ACL, cache, mock, testing, etc.',
  ...
  'app.home.feature.tool.desc': 'Includes Pokemon Schematics, VSCODE extension',
  ...
  'app.header.menu.pokemon': 'Pokemon Library',
  'app.header.menu.auth': '@pokemon/auth-Authentication',
  'app.header.menu.acl': '@pokemon/acl-Access Control List',
  'app.header.menu.cache': '@pokemon/cache-Cache',
  'app.header.menu.chart': '@pokemon/chart-Chart',
  'app.header.menu.mock': '@pokemon/mock-Mock',
  'app.header.menu.util': '@pokemon/util-Utils',
  'app.header.menu.form': '@pokemon/form-Dynamic Form',
  'app.header.menu.theme': '@pokemon/theme-Theme System',
