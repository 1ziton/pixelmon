...
import { NoticeIconList, NoticeItem } from '@pixelmon/pikachu';
...
export class DemoComponent {
  ...
  updateNoticeData(notices: NoticeIconList[]): NoticeItem[] {
    ...
    notices.forEach(item => {
      const newItem = { ...item };
      if (newItem.datetime) newItem.datetime = distanceInWordsToNow(item.datetime!, { locale: (window as any).__locale__ });
